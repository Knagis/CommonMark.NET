...
{
    [TestClass]
    public class GithubHeaderIdTests
    {
        ...
        private static CommonMarkSettings Settings
        {
            get
            {
                ...
                if (s == null)
                {
                    ...
                    s.AdditionalFeatures |= CommonMarkAdditionalFeatures.GithubStyleHeaderIds;
                    _settings = s;
                }
                return s;
            }
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsDisabledByDefault()
        {
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsExample1() {
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsExample2() {
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsExample3() {
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsExample4() {
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsExample5() {
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsExample6() {
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsExample7() {
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsExample8() {
        ...
        [TestMethod]
        [TestCategory("Container blocks - Github header IDs")]
        public void GithubHeaderIdsExample9() {
